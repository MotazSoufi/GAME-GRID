var count = 1;
            ...
            function goRight() {
                ...
                switch(count) {
                    case 1:
                        $('.gameScreenshots').css('background-image', 'url(/Images/screenshot21.jpg)');
                    break;

                    case 2:
                        $('.gameScreenshots').css('background-image', 'url(/Images/screenshot22.jpg)');
                    break;

                    case 3:
                        $('.gameScreenshots').css('background-image', 'url(/Images/screenshot23.jpg)');
                    break;

                    case 4:
                        $('.gameScreenshots').css('background-image', 'url(/Images/screenshot24.jpg)');
                    break;
                }
            }
